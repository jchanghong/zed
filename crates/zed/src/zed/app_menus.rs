    ...
    vec![
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("向项目添加文件夹…", workspace::AddFolderToProject),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("扩展选区", editor::actions::SelectLargerSyntaxNode),
                MenuItem::action("收缩选区", editor::actions::SelectSmallerSyntaxNode),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("查看依赖许可", zed_actions::OpenLicenses),
                MenuItem::action("显示欢迎页", onboarding::ShowWelcome),
                MenuItem::separator(),
                MenuItem::action("提交错误报告...", zed_actions::feedback::FileBugReport),
                MenuItem::action("提交功能请求...", zed_actions::feedback::RequestFeature),
                MenuItem::action("给我们发邮件...", zed_actions::feedback::EmailZed),
                MenuItem::separator(),
                MenuItem::action(
                    "文档",
                    super::OpenBrowser {
