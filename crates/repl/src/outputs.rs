...
impl Render for ExecutionView {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        let status = match &self.status {
            ExecutionStatus::ConnectingToKernel => Label::new("正在连接到 Kernel...")
                .color(Color::Muted)
                .into_any_element(),
            ...
            ExecutionStatus::Unknown => Label::new("未知状态")
                .color(Color::Muted)
                .into_any_element(),
            ExecutionStatus::ShuttingDown => Label::new("Kernel 正在关闭...")
                .color(Color::Muted)
                .into_any_element(),
            ExecutionStatus::Restarting => Label::new("Kernel 正在重启...")
                .color(Color::Muted)
                .into_any_element(),
            ExecutionStatus::Shutdown => Label::new("Kernel 已关闭")
                .color(Color::Muted)
                .into_any_element(),
